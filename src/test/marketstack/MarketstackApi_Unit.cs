...
namespace ApiClient.Test.Marketstack.Unit
{
    ...
    {
        [Fact]
        public async Task GetIntradayResponse_ResponseIsValid_ReturnsEodResponse()
        {
            // Arrange
            var validResponse = new IntradayResponse();
            var mocks = new Mocks()
            {
                HttpMessageHandler = new Mock<HttpMessageHandler>()
            };
            ...
            // Act
            var result = await service.GetIntradayResponseAsync([symbol], date);
        ...
        [Fact]
        public async Task GetIntradayResponse_ResponseIsInvalid_ThrowsInvaliddOperationException()
        {
            // Arrange
            var mocks = new Mocks()
            {
