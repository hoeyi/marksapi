...
namespace ApiClient.Massive
{
    ...
    {
        public async Task<TickerAggregateResponse> GetStocksTickerAsync(
            string? ticker = null, 
            ...
            int limit = 100)
        {
            ...
            var response = await GetResponseAsync<TickerAggregateResponse>(queryBuilder, Endpoint.StocksAllTickers);
