...
namespace ApiClient.Massive.Response.Economy
{
    ...
    public class InflationExpectation
    {
        ...
        [JsonProperty(PropertyName = "forward_years_5_to_10")]
        ...
        [JsonProperty(PropertyName = "market_10_year")]
        ...
        [JsonProperty(PropertyName = "market_5_year")]
        ...
        [JsonProperty(PropertyName = "model_10_year")]
        ...
        [JsonProperty(PropertyName = "model_1_year")]
        ...
        [JsonProperty(PropertyName = "model_30_year")]
        ...
        [JsonProperty(PropertyName = "model_5_year")]
