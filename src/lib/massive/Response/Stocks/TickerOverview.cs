...
public class TickerOverview
{
    ...
    [JsonProperty(PropertyName = "round_lot")]
    ...
    [JsonProperty(PropertyName = "share_class_shares_outstanding")]
    ...
    [JsonProperty(PropertyName = "ticker_root")]
    ...
    [JsonProperty(PropertyName = "ticker_suffix")]
    ...
    [JsonProperty(PropertyName = "total_employees")]
