...
namespace ApiClient.Massive.Response.Stocks
{
    ...
    public class AggregateBarResponse : CollectionResponse<AggregateBar>
    {
        ...
        /// <summary>
        /// The total number of results for this request. Specific to the 
        /// <see cref="Market.Indices"/> aggregate bar response.
        /// </summary>
        ...
        /// <summary>
        /// <see cref="ResultsCount"/> if non-null, else <see cref="Count"/> or default.
        /// </summary>
        [Newtonsoft.Json.JsonIgnore]
        [System.Text.Json.Serialization.JsonIgnore]
        public int CommonCount => ResultsCount ?? Count ?? default;
    }
}